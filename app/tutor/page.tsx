            ...
            <nav className="space-y-3">
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 font-medium rounded-xl transition ${
                  activeTab === 'create' ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-700'
                }`}
              >
                <span>📝</span>
                <span>問題作成</span>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 font-medium rounded-xl transition ${
                  activeTab === 'answers' ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-700'
                }`}
              >
                <span>📊</span>
                <span>生徒の回答・質問</span>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 font-medium rounded-xl transition ${
                  activeTab === 'records' ? 'bg-indigo-600 text-white' : 'text-slate-300 hover:bg-slate-700'
                }`}
              >
                <span>📅</span>
                <span>生徒のログイン状況</span>
