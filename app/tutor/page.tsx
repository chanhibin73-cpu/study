              ...
              <section className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6">
                ...
                <form onSubmit={handlePublishQuestion} className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 rounded-xl transition shadow text-sm disabled:opacity-50"
                  >
                  ...
                  {questions.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {questions.map((q) => {
                        ...
                        const dateStr = q.createdAt?.toDate ? q.createdAt.toDate().toLocaleString('ja-JP', { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' }) : '';
                        ...
                        return (
                          <div key={q.id} className="p-4 border border-slate-200 rounded-xl space-y-3">
                            <div className="flex justify-between items-start gap-2">
                              ...
                              {dateStr && <div className="text-[10px] text-slate-400 whitespace-nowrap pt-0.5">出題: {dateStr}</div>}
                            </div>
